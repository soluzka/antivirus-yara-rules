// Content script for Outlook Web: extracts email body and sends to phishing detector
function extractOutlookEmailBody() {
    // Outlook Web uses 'div._rp_6' or 'div.readMsgBody' for the email body
    let body = document.querySelector('div._rp_6, div.readMsgBody');
...
const observer = new MutationObserver(() => {
    let emailText = extractOutlookEmailBody();
    if (emailText) {
