...
rule Generic_Malware_Strings {
    ...
    strings:
        $str1 = "vssadmin delete shadows" ascii wide nocase
        $str2 = "Mimikatz" ascii wide nocase
        $str3 = "sekurlsa::logonpasswords" ascii wide nocase
        $str4 = "lsass.dmp" ascii wide nocase
        $str5 = "Invoke-Mimikatz" ascii wide nocase
        $str6 = "certutil -decode" ascii wide nocase
    condition:
        2 of ($str*) and uint16(0) == 0x5A4D
}
...
rule Suspicious_Network_Connections {
    ...
    strings:
        ...
        $net2 = "Invoke-RestMethod" ascii wide nocase
        $net3 = "System.Net.WebClient" ascii
        $net4 = "DownloadFileAsync" ascii
        $net5 = "certutil -urlcache" ascii wide nocase
        $net6 = "bitsadmin /transfer" ascii wide nocase
    condition:
        2 of ($net*) and uint16(0) == 0x5A4D
}
...
rule Keylogger_Indicators {
    ...
    strings:
        ...
        $key3 = "WH_KEYBOARD_LL" ascii
        $key4 = "keylog" ascii wide nocase
    condition:
        3 of ($key*) and uint16(0) == 0x5A4D
}
...
rule Suspicious_JS_Script {
    ...
    strings:
        ...
        $activex = "new ActiveXObject" ascii
        $base64 = "fromCharCode" ascii
    condition:
        // Require ActiveX + WScript.Shell (strong indicator of malicious JS)
        // fromCharCode alone is too common in legitimate JS
        ($wscript and $activex) or $shell or $base64 and filesize < 500KB
}
...
rule njRAT_Trojan {
    ...
    strings:
        $str1 = "njRAT" ascii wide nocase
        $str2 = "njw0rm" ascii wide nocase
        $str3 = "Network\\njRAT" ascii wide nocase
        $str4 = "Stub.exe" ascii wide nocase
        $str5 = "nj_rat" ascii wide nocase
        $str6 = "%njRAT%" ascii wide nocase
    condition:
        2 of ($*)
}
...
rule Suspicious_Macro_Doc {
    ...
    strings:
        ...
        $c = "CreateObject(\"WScript.Shell\")" ascii
        $d = "ShellExecute" ascii
    condition:
        3 of them
}
...
rule Ransomware_Generic {
    meta:
        ...
        author = "CascadeAI"
    strings:
        $a = "All your files have been encrypted" ascii wide nocase
        $b = "pay the ransom" ascii wide nocase
        $c = "bitcoin wallet" ascii wide nocase
        $d = "decrypt your files" ascii wide nocase
    condition:
        2 of them
}
